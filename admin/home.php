...
<div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-gradient-dark elevation-1"><a href="?page=maintenance/brands"><i class="fa-solid fa-box"></a></i></span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-gradient-dark elevation-1"><a href="?page=service_requests"><i class="fas fa-copyright"></a></i></span>
              <div class="info-box-content">
